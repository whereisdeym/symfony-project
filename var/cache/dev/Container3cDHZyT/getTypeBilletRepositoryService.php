 ...
 */
class getTypeBilletRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeBilletRepository' shared autowired service.
     *
     * @return \App\Repository\TypeBilletRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeBilletRepository.php';

        return $container->privates['App\\Repository\\TypeBilletRepository'] = new \App\Repository\TypeBilletRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
